...
/**
 * saman enrolment plugin - support for user self unenrolment.
 *
 * @package    enrol_saman
...
$instance = $DB->get_record('enrol', array('id' => $enrolid, 'enrol' => 'saman'), '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/saman/unenrolself.php', array('enrolid' => $instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_saman', format_string($course->fullname));
